# Streaming LLM Response Support for Cyberfox Agent
...
```
CYBERFOX_STREAMING_ENABLED=true    # Master switch via env
```
...
try:
    ...
    pass
# Env var override
if os.getenv("CYBERFOX_STREAMING_ENABLED", "").lower() in ("true", "1", "yes"):
...
| `cyberfox_cli/config.py` | 1 | +streaming config defaults |
...
CYBERFOX_STREAMING_ENABLED=true
```
