...
(3 SDK retries x 3 Cyberfox retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_cyberfox_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".cyberfox")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Cyberfox, ...) behind one endpoint.  A 429 can mean either:
