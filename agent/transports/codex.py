...
class ResponsesApiTransport(ProviderTransport):
    ...
    def build_kwargs(
        ...
        **params,
        ...
        # that would silently route around Cyberfox's web-provider config and
        ...
        # native search engine for xAI sessions instead of Cyberfox's
        # configured web provider (Tavily/etc.), and those results bypass
        # Cyberfox's tool-trace / citation plumbing (they arrive baked into the
