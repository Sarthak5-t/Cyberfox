...
def build_turn_context(
    ...
    *,
    ...
    # Tag log records on this thread with the session ID for ``cyberfox logs``.
    ...
    if agent.compression_enabled and _should_run_preflight_estimate(
        ...
        # Cyberfox only initiates compaction in "cyberfox" mode (#36801).
        _codex_native_auto = (
        ...
        if _preflight_deferred:
            ...
            logger.info(
                "Skipping Cyberfox preflight compression for codex app-server "
                "(mode=%s); Cyberfox will not start thread compaction here.",
