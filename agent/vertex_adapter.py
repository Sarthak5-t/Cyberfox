"""Vertex AI (Google Cloud) adapter for Cyberfox Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows Cyberfox to use Gemini models via Google Cloud with
...
# who installed plain `cyberfox-agent` and only later selected a Gemini model.
try:
