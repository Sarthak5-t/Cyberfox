...
//!      rebuild apps/desktop by design — see cmd_update in cyberfox_cli/main.py),
...
/// cyberfox_cli/main.py (sys.exit(2)). We surface a targeted message for this.
