...
cd apps/desktop
XCURSOR_SIZE=24 CYBERFOX_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/cyberfox-typing
# → /tmp/cyberfox-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/cyberfox-typing.before.heapsnapshot
# → /tmp/cyberfox-typing.after.heapsnapshot
```
