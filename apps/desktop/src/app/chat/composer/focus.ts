...
const FOCUS_EVENT = 'cyberfox:composer-focus'
const INSERT_EVENT = 'cyberfox:composer-insert'
const INSERT_REFS_EVENT = 'cyberfox:composer-insert-refs'
const SUBMIT_EVENT = 'cyberfox:composer-submit'
const VOICE_TOGGLE_EVENT = 'cyberfox:composer-voice-toggle'
