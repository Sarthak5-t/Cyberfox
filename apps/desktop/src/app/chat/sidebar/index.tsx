...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/cyberfox'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('cyberfox:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('cyberfox:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Cyberfox to
