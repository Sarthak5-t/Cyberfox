...
import type { ProjectInfo, SessionInfo } from '@/cyberfox'
 ...
 * repo shows its branches/worktrees even when they have no Cyberfox sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: CyberfoxGitWorktree[]
): SidebarSessionGroup[] {
