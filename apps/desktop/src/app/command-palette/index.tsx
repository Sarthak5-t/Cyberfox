...
import { getCyberfoxConfigRecord, listAllProfileSessions } from '@/cyberfox'
...
// Cyberfox session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
export function CommandPalette() {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getCyberfoxConfigRecord,
    enabled: open
  })
    ...
    return [
      ...
      ...branchGroup,
      {
        ...
        items: [
          ...
          {
            icon: Download,
            id: 'cc-update-cyberfox',
            keywords: ['update', 'upgrade', 'cyberfox', 'version', 'system', 'restart'],
            label: cc.updateCyberfox,
