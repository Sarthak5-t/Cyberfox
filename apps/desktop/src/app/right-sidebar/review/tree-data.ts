import type { CyberfoxReviewFile } from '@/global'
...
export function buildReviewFlatList(files: CyberfoxReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: CyberfoxReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
