...
const TAKEOVER_KEY = 'cyberfox.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Cyberfox can't clear via the API — the user
 *  sees exactly what runs instead of Cyberfox silently deleting their creds. */
