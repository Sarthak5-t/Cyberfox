...
describe('settings helpers', () => {
  ...
  it('reads and writes nested config paths', () => {
    const config: CyberfoxConfigRecord = { display: { theme: 'mono' } }
  ...
  it('rejects prototype-polluting config paths', () => {
    const config: CyberfoxConfigRecord = {}
  ...
  describe('providerGroup', () => {
    ...
    it('prefers the longest matching prefix so CN/regional buckets win', () => {
      ...
      // CYBERFOX_QWEN_ shares the CYBERFOX_ stem with other integrations.
      expect(providerGroup('CYBERFOX_QWEN_BASE_URL')).toBe('DashScope (Qwen)')
