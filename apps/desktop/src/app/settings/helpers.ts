...
import type { CyberfoxConfigRecord, ToolsetInfo } from '@/types/cyberfox'
...
export function getNested(obj: CyberfoxConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: CyberfoxConfigRecord, path: string, value: unknown): CyberfoxConfigRecord {
...
function personalityOptions(config: CyberfoxConfigRecord): string[] {
