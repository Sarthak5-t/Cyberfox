...
import { deleteSession, listAllProfileSessions, setSessionArchived } from '@/cyberfox'
...
// / Program Files), which buried any files Cyberfox wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.cyberfoxDesktop` is
    ...
    const settings = window.cyberfoxDesktop?.settings
