...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/cyberfox'
...
const VERSION = 3
const PREFIX = 'HML' // "Cyberfox Memory Loadout" — namespaces our codes like WoW's leading bytes.
