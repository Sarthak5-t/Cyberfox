  ...
  it('shows failed title when navigate returns success=false', () => {
    const view = buildToolView(
      part({
        ...
        args: { url: 'https://cyberfox-agent.nousresearch.com/docs' },
    ...
    expect(view.title).toBe('Failed to open cyberfox-agent.nousresearch.com')
  })
  ...
  it('shows opened title on success', () => {
    const view = buildToolView(
      part({
        toolName: 'browser_navigate',
        args: { url: 'https://cyberfox-agent.nousresearch.com/docs' },
        result: { success: true, url: 'https://cyberfox-agent.nousresearch.com/docs', title: 'Docs' }
      }),
      ''
    )

    expect(view.status).toBe('success')
    expect(view.title).toBe('Opened cyberfox-agent.nousresearch.com')
  })
})
