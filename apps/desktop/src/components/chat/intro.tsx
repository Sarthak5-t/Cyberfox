...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Cyberfox look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Cyberfox need to see?`,
    ...
    {
      headline: `What should ${label} Cyberfox tackle?`,
