...
export const en: Translations = {
  ...
  boot: {
    ready: 'Cyberfox Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Cyberfox settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingCyberfoxDesktop: 'Starting Cyberfox Desktop…'
    },
    errors: {
      backgroundExited: 'Cyberfox background process exited.',
      backgroundExitedDuringStartup: 'Cyberfox background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Cyberfox backend is older than this desktop build and may not work correctly. Update to align them.',
    updateCyberfox: 'Update Cyberfox',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Cyberfox Desktop.',
    ...
    native: {
      ...
      inputBody: 'Cyberfox is waiting for your response.',
      turnDoneTitle: 'Cyberfox finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Cyberfox defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Cyberfox is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Cyberfox asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Cyberfox was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Cyberfox follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Cyberfox is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Cyberfox, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Cyberfox checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Cyberfox configuration...',
    ...
    gateway: {
      ...
      intro:
        'Cyberfox Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Cyberfox backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset CYBERFOX_DESKTOP_REMOTE_URL and CYBERFOX_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Cyberfox backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Cyberfox backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /cyberfox.',
      ...
      restartingMessage: 'Cyberfox Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Cyberfox ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Cyberfox runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via cyberfox curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Cyberfox builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Cyberfox to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Cyberfox to generate pets.',
      backgroundHint: 'You can close this — Cyberfox will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Cyberfox desktop' },
    ...
    cyberfoxActiveSessions: (version, count) => `Cyberfox ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@cyberfox:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Cyberfox environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Cyberfox will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Cyberfox backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Cyberfox. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Cyberfox...',
    placeholderReconnecting: 'Reconnecting to Cyberfox…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Cyberfox a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Cyberfox will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Cyberfox to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Cyberfox…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Cyberfox…',
    ...
    unsupportedMessage: 'This version of Cyberfox can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Cyberfox from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Cyberfox will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Cyberfox desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Cyberfox updater takes over in its own window and reopens Cyberfox automatically when it’s done. Please don’t reopen Cyberfox yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Cyberfox reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Cyberfox reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Cyberfox needs a one-time install',
    ...
    settingUpTitle: 'Setting up Cyberfox Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Cyberfox CLI or desktop instance is running. Stop any running Cyberfox instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Cyberfox Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Cyberfox is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Cyberfox…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Cyberfox',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Cyberfox at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Cyberfox connects automatically',
    ...
    authorizeThere: 'Authorize Cyberfox there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Cyberfox there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Cyberfox Desktop v${version}`,
      ...
      gatewayTitle: 'Cyberfox inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Cyberfox will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Cyberfox is restarting...',
      askRestart: 'Ask Cyberfox to restart the server',
      lookingRestart: taskId => `Cyberfox is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Cyberfox is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Cyberfox finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Cyberfox could not restart the server.',
      stillWorking:
        'Cyberfox is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Cyberfox is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Cyberfox gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.cyberfox/config.yaml). Cyberfox won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Cyberfox needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Cyberfox needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Cyberfox Desktop to use Save Image.',
    restartToSaveImages: 'Restart Cyberfox Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `cyberfox gateway` running?'
    }
  },
