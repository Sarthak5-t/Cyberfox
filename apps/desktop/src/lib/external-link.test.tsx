...
const desktopWindow = window as unknown as { cyberfoxDesktop?: Window['cyberfoxDesktop'] }
const initialCyberfoxDesktop = desktopWindow.cyberfoxDesktop

function installDesktopBridge(partial: Partial<Window['cyberfoxDesktop']> = {}) {
  desktopWindow.cyberfoxDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['cyberfoxDesktop']
}
...
afterEach(() => {
  ...
  if (initialCyberfoxDesktop) {
    desktopWindow.cyberfoxDesktop = initialCyberfoxDesktop
  } else {
    delete desktopWindow.cyberfoxDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['cyberfoxDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['cyberfoxDesktop']['openExternal'] })
