...
import type { CyberfoxGitWorktree, CyberfoxRepoStatus } from '@/global'
...
export const $repoStatus = atom<CyberfoxRepoStatus | null>(null)
...
export const $repoWorktrees = atom<CyberfoxGitWorktree[]>([])
