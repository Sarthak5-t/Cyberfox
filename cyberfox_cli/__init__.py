"""
Cyberfox CLI - Unified command-line interface for Cyberfox Agent.

Provides subcommands for:
- cyberfox chat          - Interactive chat (same as ./cyberfox)
- cyberfox gateway       - Run gateway in foreground
- cyberfox gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `cyberfox setup` on a fresh Pi.
    ...
    cyberfox_cli/stdio.py::configure_windows_stdio() runs later from the entry
