...
_DEP_CHECKS = {
    ...
    "browser": lambda: (
        ...
        or _has_cyberfox_agent_browser()
    ),
...
def _has_cyberfox_agent_browser() -> bool:
    ...
    # install.sh installs globally into $CYBERFOX_HOME/node/bin/ via npm -g --prefix
...
def ensure_dependency(
    ...
    if shell == "powershell":
        ...
        cmd = [
            ...
            "-File", str(script),
            "-Ensure", dep,
            "-CyberfoxHome", str(get_cyberfox_home()),
        ]
    else:
        cmd = ["bash", str(script), "--ensure", dep]

    run_env = cyberfox_subprocess_env(inherit_credentials=False)
