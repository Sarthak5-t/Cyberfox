"""Client for uploading ``cyberfox debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``cyberfox debug share``.
...
NAS_BASE = os.environ.get(
    "CYBERFOX_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com"
)
...
_USER_AGENT = "cyberfox-agent/debug-share"
