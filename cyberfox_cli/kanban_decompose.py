...
Invoked by ``cyberfox kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Cyberfox Agent board.
...
def _profile_author() -> str:
    """Mirror of ``cyberfox_cli.kanban._profile_author``."""
    return (
