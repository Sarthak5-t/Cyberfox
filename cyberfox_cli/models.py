...
# (``get_default_model_for_provider``). Providers whose curated lists are
# ordered most-capable-first carry an explicit low-cost override so a
# missing model can never auto-escalate to the flagship.
#
...
# richer resolver — see ``get_recommended_default_model``
# in cyberfox_cli/web_server.py — which can hit the network; this fallback
# must stay cheap and network-free.
