...
Usage:
    cyberfox pairing list              # Show all pending + approved users
    cyberfox pairing approve <platform> <code>  # Approve a pairing code
    cyberfox pairing revoke <platform> <user_id> # Revoke user access
    cyberfox pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle cyberfox pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: cyberfox pairing {list|approve|revoke|clear-pending}")
        print("Run 'cyberfox pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.cyberfox/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'cyberfox pairing list' to see pending codes.\n")
