...
Used by ``cyberfox profile describe <name> --auto`` and the dashboard's
...
Design notes
------------
- Mirrors the shape of ``cyberfox_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are a profile-describer for the Cyberfox Agent kanban board.
...
Rules:
  ...
  - Never write "Cyberfox Agent profile" or other meta-narration.
    ...
    *,
    ...
    try:
        if canon == "default":
            ...
            profile_dir = Path(get_cyberfox_home())
        else:
