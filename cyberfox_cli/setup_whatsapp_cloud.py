...
Entry point: ``cyberfox whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``cyberfox_cli/main.py``).
...
Cyberfox gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Cyberfox to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Cyberfox needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Cyberfox gateway in another terminal:")
    print("         cyberfox gateway")
    print()
    ...
    print()
    print("  Docs: https://cyberfox-agent.nousresearch.com/docs/user-guide/")
