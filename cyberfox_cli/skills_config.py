"""
Skills configuration for Cyberfox Agent.
`cyberfox skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.cyberfox/config.yaml under:
...
from cyberfox_cli.config import cfg_get, load_config, save_config
from cyberfox_cli.colors import Colors, color
from cyberfox_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `cyberfox skills`."""
    from cyberfox_cli.curses_ui import curses_checklist
