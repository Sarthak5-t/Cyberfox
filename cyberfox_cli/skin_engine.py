"""Cyberfox CLI skin/theme engine.

A data-driven skin system that lets users customize the CLI's visual appearance.
Skins are defined as YAML files in ~/.cyberfox/skins/ or as built-in presets.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Cyberfox Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ Cyberfox "       # Response box header label
...
.. code-block:: python
    ...
    from cyberfox_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "Cyberfox Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.cyberfox/skins/

BUILT-IN SKINS
==============

- ``default`` — Classic Cyberfox gold/kawaii (the current look)
...
Drop a YAML file in ``~/.cyberfox/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces CYBERFOX_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces CYBERFOX_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Cyberfox — foxfire and midnight",
        "colors": {
            "banner_border": "#E85D04",
            "banner_title": "#FFB703",
            "banner_accent": "#FB8500",
            "banner_dim": "#6A040F",
            "banner_text": "#FFF3E0",
            "ui_accent": "#E85D04",
            "ui_label": "#FFB703",
            ...
            "prompt": "#FFF3E0",
            "input_rule": "#E85D04",
            "response_border": "#FFB703",
            "status_bar_bg": "#1A0A02",
            "status_bar_text": "#FFF3E0",
            "status_bar_strong": "#FFB703",
            "status_bar_dim": "#8B4513",
            "status_bar_good": "#7BC96F",
            "status_bar_warn": "#FFB703",
            "status_bar_bad": "#E85D04",
            "status_bar_critical": "#EF5350",
            "session_label": "#FFB703",
            "session_border": "#8B4513",
        },
        "spinner": {
            "waiting_faces": ["(\U0001f525)", "(\u2726)", "(\u25b2)", "(<>)", "(/)"],
            "thinking_faces": ["(\U0001f525)", "(\u2726)", "(\u25b2)", "(\u2301)", "(<>)"],
            "thinking_verbs": [
                "prowling", "hunting", "scenting the path", "circling the target",
                "stalking prey", "baring fangs", "calling the pack", "leaping the gap",
            ],
            "wings": [
                ["\u27eb\U0001f525", "\U0001f525\u27eb"],
                ["\u27eb\u2726", "\u2726\u27eb"],
        ...
        "branding": {
            "agent_name": "Cyberfox",
            "welcome": "Welcome to Cyberfox! Type your message or /help for commands.",
            "goodbye": "Hunt well! \U0001f525",
            "response_label": " \U0001f525 Cyberfox ",
            "prompt_symbol": "\U0001f525",
            "help_header": "(\U0001f525) Available Commands",
        },
        "tool_prefix": "\u2573",
    },
    "ares": {
...
[#6A040F] \u255a\u2550\u2550\u2550\u2550\u2550\u255d   \u255a\u2550\u255d   \u255a\u2550\u2550\u2550\u2550\u2550\u255d \u255a\u2550\u2550\u2550\u2550\u2550\u255d\u255a\u2550\u255d  \u255a\u2550\u255d\u255a\u2550\u255d  \u255a\u2550\u255d\u255a\u2550\u2550\u2550\u2550\u2550\u255d\u255a\u2550\u255d\u255a\u2550\u255d \u255a\u2550\u255d      \u255a\u2550\u255d  \u255a\u2550\u255d \u255a\u2550\u2550\u2550\u2550\u2550\u255d \u255a\u2550\u2550\u2550\u2550\u2550\u255d\u255a\u2550\u255d  \u255a\u2550\u2550\u2550\u255d   \u255a\u2550\u255d[/]""",
  ...
  jgs \`--\`       ,  |  ,                              
    ...
    \\\`---.____/  / /                                    
      ...
      \`---------'\                                     
[bold #FFB703]  ___       __                        __            
 / _ \__ _ / _|  __ ___ _ _ ___  ___  ___ _ _| |_           
| (_) \` |  _| / _/ _ \ ' \___|/ _ \/ _ \ ' \  _|          
 \___/_|_|_| |_| \___/_||_|    \___/\___/_||_|\__|          
[/]                                                                                  
[dim #6A040F]           foxfire protocols online[/]""",
    },
    "mono": {
        "name": "mono",
        ...
        "branding": {
            ...
            "welcome": "Welcome to Cyberfox Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
            "response_label": " ⚕ Cyberfox ",
            "prompt_symbol": "❯",
...
def _skins_dir() -> Path:
    ...
    return get_cyberfox_home() / "skins"
