"""``cyberfox tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'cyberfox tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # cyberfox tools list [--platform cli]
    ...
    # cyberfox tools disable <name...> [--platform cli]
    ...
    # cyberfox tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `cyberfox tools` runs after you pick a provider that\n"
