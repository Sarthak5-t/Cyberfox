"""``cyberfox uninstall`` subcommand parser.
...
def build_uninstall_parser(subparsers, *, cmd_uninstall: Callable) -> None:
    ...
    uninstall_parser = subparsers.add_parser(
        "uninstall",
        help="Uninstall Cyberfox Agent",
        description="Remove Cyberfox Agent from your system. Can keep configs/data for reinstall.",
    )
