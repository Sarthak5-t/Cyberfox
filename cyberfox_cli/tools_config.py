...
from cyberfox_cli.nous_subscription import (
    apply_nous_managed_defaults,
    get_nous_subscription_features,
)
from cyberfox_cli.nous_account import format_nous_portal_entitlement_message
...
def _configure_provider(
    ...
    *,
    ...
    # "enable all tools" prompt (that lives in `cyberfox model`).
    if managed_feature:
        from cyberfox_cli.nous_subscription import (
...
def tools_command(args=None, first_install: bool = False, config: dict = None):
    ...
    print(color("  Guide: https://cyberfox-agent.nousresearch.com/docs/user-guide/features/tools", Colors.DIM))
    print()
