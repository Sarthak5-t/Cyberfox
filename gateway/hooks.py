...
Hooks are discovered from ~/.cyberfox/hooks/ directories, each containing:
...
Context dict passed to ``agent:start`` / ``agent:end`` handlers:
  ...
  session_id   -- Cyberfox session id
...
HOOKS_DIR = get_cyberfox_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"cyberfox_hook_{hook_name}"
