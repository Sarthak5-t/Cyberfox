...
try:
    ...
    _CYBERFOX_VERSION = "0.0.0"

_APP_VERSION = _CYBERFOX_VERSION
_BOT_VERSION = _CYBERFOX_VERSION
_YUANBAO_INSTANCE_ID = str(CYBERFOX_INSTANCE_ID)  # single source: yuanbao_proto.CYBERFOX_INSTANCE_ID
