...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$CYBERFOX_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_cyberfox_dir("platforms/whatsapp/session", "whatsapp/session")
