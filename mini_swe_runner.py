#!/usr/bin/env python3
"""
SWE Runner with Cyberfox Trajectory Format

A runner that uses Cyberfox-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Cyberfox-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Cyberfox-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Cyberfox format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Cyberfox-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Cyberfox-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Cyberfox Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Cyberfox-Agent's built-in execution environments
    and outputs trajectories in Cyberfox-Agent format.
    """
    ...
    def _convert_to_cyberfox_format(
        self,
        ...
        """
        Convert internal message format to Cyberfox trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Cyberfox trajectory format
        trajectory = self._convert_to_cyberfox_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Cyberfox trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Cyberfox Trajectory Format")
    print("=" * 60)
