...
{ ... }:
{
  perSystem =
    ...
    let
      ...
      cyberfoxNpmLib = self'.packages.default.passthru.cyberfoxNpmLib;
      ...
      # Non-npm packages may have their own devShellHook (e.g. cyberfox-agent
    ...
    in
    {
      devShells.default = pkgs.mkShell {
        ...
        shellHook = ''
          echo "Cyberfox Agent dev shell"
          ${combinedNonNpm}
          ${cyberfoxNpmLib.mkNpmDevShellHook npmPackageJsonPaths}
          echo "Ready. Run 'cyberfox' to start."
        '';
      };
    };
}
