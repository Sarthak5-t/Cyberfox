# nix/packages.nix — Cyberfox Agent package built with uv2nix
{ inputs, ... }:
{
  perSystem =
    {
    ...
    let
      minimal = pkgs.callPackage ./cyberfox-agent.nix {
    ...
    in
    {
      packages = {
        ...
        tui = full.cyberfoxTui;
        web = full.cyberfoxWeb;
        desktop = full.cyberfoxDesktop;
      };
    };
}
