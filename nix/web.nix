# nix/web.nix — Cyberfox Web Dashboard (Vite/React) frontend build
{ pkgs, cyberfoxNpmLib, ... }:
let
  npm = cyberfoxNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "cyberfox-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../cyberfox_cli/web_dist for the
