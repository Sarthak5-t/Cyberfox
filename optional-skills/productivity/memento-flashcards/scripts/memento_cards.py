...
Data file: $CYBERFOX_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_CYBERFOX_HOME = Path(os.environ.get("CYBERFOX_HOME", Path.home() / ".cyberfox"))
DATA_DIR = _CYBERFOX_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
