...
def _handle_save(args: dict, **kw) -> str:
    try:
        ...
        return json_result(False, error=f"entity_save failed: {e}")
...
def _handle_query(args: dict, **kw) -> str:
    try:
        ...
        return json_result(False, error=f"entity_query failed: {e}")
...
def _handle_graph(args: dict, **kw) -> str:
    try:
        ...
        return json_result(False, error=f"entity_graph failed: {e}")
...
def _handle_link(args: dict, **kw) -> str:
    try:
        ...
        return json_result(False, error=f"entity_link failed: {e}")
...
def _handle_count(args: dict, **kw) -> str:
    try:
        ...
        return json_result(False, error=f"entity_count failed: {e}")
