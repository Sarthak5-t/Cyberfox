# Cyberfox Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.cyberfox/plugins/cyberfox-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.cyberfox/plugins/cyberfox-achievements/scan_checkpoint.json`.
