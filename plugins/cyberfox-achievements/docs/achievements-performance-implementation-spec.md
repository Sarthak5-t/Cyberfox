# Cyberfox Achievements Implementation Spec (Detailed)
...
- persisted runtime files:
  - `~/.cyberfox/plugins/cyberfox-achievements/state.json` (existing unlock state)
  - `~/.cyberfox/plugins/cyberfox-achievements/scan_snapshot.json` (new)
  - `~/.cyberfox/plugins/cyberfox-achievements/scan_checkpoint.json` (new)
