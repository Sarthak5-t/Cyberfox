...
Config: ~/.cyberfox/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.cyberfox/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_cyberfox_home()`` helper (CYBERFOX_HOME-aware and
...
RULES_FILE = get_cyberfox_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_cyberfox_home() / "feishu_comment_pairing.json"
