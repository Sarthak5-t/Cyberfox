...
required — uses aiohttp which is already a Cyberfox dependency.
...
def interactive_setup() -> None:
    ...
    ``cyberfox_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Cyberfox delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # cyberfox_cli/setup.py::_setup_mattermost function.
