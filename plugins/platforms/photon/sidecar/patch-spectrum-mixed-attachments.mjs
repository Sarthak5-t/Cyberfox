...
// `message.content.text` before Cyberfox can see it. We rewrite the two inbound
...
const MARKER = "Cyberfox patch: Preserve mixed text + attachment iMessage payloads";
