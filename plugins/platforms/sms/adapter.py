...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Cyberfox gateway adapter.

    Each inbound phone number gets its own Cyberfox session (multi-tenant).
...
# static dict in cyberfox_cli/gateway.py, and the _send_sms dispatch in
