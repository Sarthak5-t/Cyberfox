...
``_check_spotify_available()`` — when the user has not run ``cyberfox auth
spotify``, the tools remain registered (so they appear in ``cyberfox
...
The Spotify auth flow (``cyberfox auth spotify``), CLI plumbing, and docs
