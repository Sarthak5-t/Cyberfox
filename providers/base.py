...
def _profile_user_agent() -> str:
    """Return a ``cyberfox-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from cyberfox_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"cyberfox-cli/{_ver}"
    except Exception:
        return "cyberfox-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # cyberfox-cli UA so the catalog endpoint is reachable.
