#!/usr/bin/env python3
"""Build the Cyberfox Model Catalog — a centralized JSON manifest of curated models.
...
Cyberfox CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Cyberfox release.
...
# Ensure CYBERFOX_HOME is set for imports that touch it at module level.
os.environ.setdefault("CYBERFOX_HOME", os.path.join(os.path.expanduser("~"), ".cyberfox"))

from cyberfox_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "cyberfox-agent repo",
            "docs": "https://cyberfox-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
