#!/usr/bin/env python3
"""Build the Cyberfox Skills Index — a centralized JSON catalog of all skills.
...
`cyberfox skills search/install` can use it without hitting the GitHub API.
...
# Ensure CYBERFOX_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Cyberfox Skills Index...", flush=True)
