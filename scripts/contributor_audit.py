...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Cyberfox\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "cyberfox@nousresearch.com",
    "cyberfox-audit@example.com",
    "cyberfox@habibilabs.dev",
    "omx@oh-my-codex.dev",
    "codex@openai.com",
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/cyberfox-agent",
                "--state", "merged",
