...
DEFAULT_DATASETS = [
    ...
    "NousResearch/cyberfox-agent-megascience-sft1",
    "NousResearch/Cyberfox-Agent-Thinking-GLM-4.7-SFT2",
    "NousResearch/Cyberfox-Agent-Thinking-GLM-4.7-SFT1",
    "NousResearch/terminal-tasks-glm-cyberfox-agent"
]
