...
Built for [Cyberfox Agent](https://github.com/NousResearch/cyberfox-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/cyberfox-agent/skills/creative/ascii-video`](https://github.com/NousResearch/cyberfox-agent/tree/main/skills/creative/ascii-video) via PR.
