...
description: "Master the complete penetration testing lifecycle from reconnaissance through reporting. Covers the five stages of ethical hacking methodology, essential tools, attack techniques, and professional reporting for authorized security assessments."
version: 1.0.0
author: Cyberfox Agent
license: MIT
metadata:
  cyberfox:
    tags: [pentest, ethical-hacking, methodology, owasp, kali, metasploit, reporting]
    related_skills: [red-teaming/red-team-tactics, red-teaming/active-directory-attacks, ares/recon, ares/scanning, ares/exploit]
