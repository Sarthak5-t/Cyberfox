...
def test_cyberfox_meta_tolerates_non_dict():
    assert learning_graph._cyberfox_meta({"metadata": "junk"}) == {}
    assert learning_graph._cyberfox_meta({"metadata": {"cyberfox": "junk"}}) == {}
    assert learning_graph._cyberfox_meta({"metadata": {"cyberfox": {"category": "x"}}}) == {"category": "x"}
