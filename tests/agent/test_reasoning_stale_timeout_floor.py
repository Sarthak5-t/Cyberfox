...
thinking phase.  Cyberfox's default cloud-stream stale detector
(``CYBERFOX_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``CYBERFOX_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
