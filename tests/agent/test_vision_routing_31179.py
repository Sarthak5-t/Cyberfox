...
def isolated_home(monkeypatch):
    """Temp CYBERFOX_HOME with config + clean credential env vars."""
    test_home = tempfile.mkdtemp(prefix="cyberfox_test_31179_")
    cyberfox_home = os.path.join(test_home, ".cyberfox")
    os.makedirs(cyberfox_home)
...
def _fresh_modules():
    """Drop cached cyberfox modules so each test reloads against current env."""
