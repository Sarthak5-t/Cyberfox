"""Tests for CodexEventProjector — codex item/* events → Cyberfox messages list.
...
class TestRoleAlternationInvariant:
    ...
    one item — that breaks Cyberfox' message alternation invariant."""
