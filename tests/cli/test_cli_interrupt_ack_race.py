...
Root cause: ``CyberfoxCLI.chat()`` fires ``agent.interrupt(msg)`` from its
...
def _make_cli():
    """Build a CyberfoxCLI with prompt_toolkit stubbed (same pattern as
