...
def test_new_command_rotates_cyberfox_session_id_env_and_context(tmp_path):
    ...
    assert cli.session_id != old_session_id
    assert os.environ["CYBERFOX_SESSION_ID"] == cli.session_id
    assert get_session_env("CYBERFOX_SESSION_ID") == cli.session_id
