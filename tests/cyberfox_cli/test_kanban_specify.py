"""Tests for the specifier module + `cyberfox kanban specify` CLI surface.
...
from cyberfox_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `cyberfox kanban …` argparse surface directly."""
