"""Tests for the interactive session browser (`cyberfox sessions browse`).
...
from cyberfox_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """cyberfox sessions browse should be parseable."""
