...
The main() function in cyberfox_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `cyberfox -c model`
...
def _build_parser():
    """Build a minimal replica of the cyberfox top-level parser."""
