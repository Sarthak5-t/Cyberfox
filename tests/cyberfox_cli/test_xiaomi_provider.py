...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from cyberfox_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in CYBERFOX_OVERLAYS
        overlay = CYBERFOX_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify cyberfox doctor recognizes Xiaomi env vars."""
