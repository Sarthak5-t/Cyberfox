...
The unit tests in tests/cyberfox_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned cyberfox-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/cyberfox")
from cyberfox_cli.service_manager import S6ServiceManager
