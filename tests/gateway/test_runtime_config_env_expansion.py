...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("CYBERFOX_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("CYBERFOX_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("CYBERFOX_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
