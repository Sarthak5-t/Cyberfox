...
def store(tmp_path, monkeypatch):
    ...
    ~/.cyberfox/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at cyberfox_state import time, before pytest's CYBERFOX_HOME monkeypatch
    fires — the autouse fixture's CYBERFOX_HOME override doesn't help here.)
    """
