"""Tests for _setup_feishu() in cyberfox_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("cyberfox_cli.config.save_env_value", side_effect=mock_save), \
         patch("cyberfox_cli.config.get_env_value", side_effect=mock_get), \
         patch("cyberfox_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("cyberfox_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("cyberfox_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("cyberfox_cli.cli_output.print_header"), \
         patch("cyberfox_cli.cli_output.print_info"), \
         patch("cyberfox_cli.cli_output.print_success"), \
         patch("cyberfox_cli.cli_output.print_warning"), \
         patch("cyberfox_cli.cli_output.print_error"), \
