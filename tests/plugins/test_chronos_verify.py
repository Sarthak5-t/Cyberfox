...
AUD = "agent:inst-123"
ISS = "https://github.com/Sarthak5-t/Cyberfox"
...
def test_jwks_url_path_resolves_key(rsa_keys, monkeypatch):
    ...
    class FakeJWKClient:
        def __init__(self, url):
            assert url == "https://github.com/Sarthak5-t/Cyberfox/.well-known/jwks.json"
    ...
    claims = verify_nas_fire_token(
        ...
        jwks_or_key="https://github.com/Sarthak5-t/Cyberfox/.well-known/jwks.json",
        issuer=ISS,
    )
