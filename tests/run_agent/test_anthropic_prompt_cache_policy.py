...
class TestQwenAlibabaFamily:
    ...
    def test_qwen_on_legacy_portal_caches_with_envelope_layout(self):
        # cyberfox portal Qwen takes the same envelope-layout cache_control
    ...
    def test_non_qwen_non_claude_on_legacy_portal_does_not_cache(self):
