...
def worker_loop(worker_id: int, cyberfox_home: str, result_file: str) -> None:
...
def reclaimer_loop(cyberfox_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="cyberfox_mixed_stress_")
    print(f"CYBERFOX_HOME = {home}")
