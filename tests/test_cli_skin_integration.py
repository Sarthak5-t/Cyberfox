...
class TestCompactBannerSkinIntegration:
    def test_default_compact_banner_uses_cyberfox_branding(self):
        set_active_skin("default")
        ...
        assert "CYBERFOX - AI Agent Framework" in banner
    ...
    def test_poseidon_compact_banner_uses_skin_branding_instead_of_default(self):
        ...
        assert "CYBERFOX - AI Agent Framework" not in banner
