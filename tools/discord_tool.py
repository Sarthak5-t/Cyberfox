...
Only included in the cyberfox-discord toolset, so it has zero cost
...
def _discord_request(
    ...
    req = urllib.request.Request(
        ...
        headers={
            ...
            "User-Agent": "Cyberfox-Agent (https://github.com/NousResearch/cyberfox-agent)",
        },
    )
...
def _capability_disk_cache_path() -> "Path":
    ...
    return get_cyberfox_home() / "cache" / "discord_capabilities.json"
