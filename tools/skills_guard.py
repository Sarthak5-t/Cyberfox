...
Trust levels:
  - builtin:   Ships with Cyberfox. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.cyberfox/\.env|\~/\.cyberfox/\.env',
     "cyberfox_env_access", "critical", "exfiltration",
     "directly references Cyberfox secrets file"),
    ...
    (r'\.cyberfox/config\.yaml|\.cyberfox/SOUL\.md',
     "cyberfox_config_mod", "critical", "persistence",
     "references Cyberfox configuration files directly"),
...
# scan. `.skillignore` is the Cyberfox-native name; `.clawhubignore` is honored
