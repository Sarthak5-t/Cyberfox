...
await build({
  ...
  // Skip the prebuilt @cyberfox/ink bundle and inline the source instead:
  ...
  alias: { '@cyberfox/ink': resolve(root, 'packages/cyberfox-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The cyberfox_cli launcher
