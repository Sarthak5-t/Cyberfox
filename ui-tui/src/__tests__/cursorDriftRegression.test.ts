 ...
 *
 * Symptom: in `cyberfox --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@cyberfox/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using cyberfox --tui and as i type multiline my caret at the end will often ' +
