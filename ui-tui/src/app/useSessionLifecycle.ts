...
import type { ScrollBoxHandle } from '@cyberfox/ink'
import { evictInkCaches } from '@cyberfox/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.CYBERFOX_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
