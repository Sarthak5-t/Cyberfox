import { Box, type ScrollBoxHandle, stringWidth, Text } from '@cyberfox/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (CYBERFOX_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (CYBERFOX_DEV_CREDITS), lowest priority,
