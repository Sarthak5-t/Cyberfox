import { Box, Text, useInput } from '@cyberfox/ink'
...
function ConfirmScreen({
  ...
  return (
    <Box flexDirection="column">
      ...
      <Text color={t.color.muted}>{payLine}</Text>
      <Text color={t.color.muted}>By confirming, you allow Cyberfox to charge your card.</Text>
      <Text />
...
function AutoReloadScreen({ ctx, onClose, onPatch, s, t }: ScreenProps) {
  ...
  return (
    <Box flexDirection="column">
      ...
      <Text />
      <Text color={t.color.muted}>
        By confirming, you authorize Cyberfox to charge {s.card ? s.card.masked : 'your card'} whenever your
