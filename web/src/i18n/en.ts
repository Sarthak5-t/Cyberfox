...
export const en: Translations = {
  ...
  status: {
    ...
    updateCyberfoxConfirmMessage:
      "This runs cyberfox update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateCyberfoxConfirmNow: "Update now",
    updateCyberfoxConfirmTitle: "Update Cyberfox?",
    updatingCyberfox: "Updating Cyberfox…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Cyberfox plugins (`cyberfox plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.cyberfox/plugins/?",
    removeHint: "Only user-installed plugins under ~/.cyberfox/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.cyberfox/skills/",
  ...
  config: {
    configPath: "~/.cyberfox/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Cyberfox doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Cyberfox Achievements",
      subtitle:
        "Collectible Cyberfox badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Cyberfox session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Cyberfox more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Cyberfox sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Cyberfox is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Cyberfox Agent ☤",
    },
  },
