...
export interface Translations {
  ...
  status: {
    ...
    stopped: string;
    updateCyberfox: string;
    updateCyberfoxConfirmMessage?: string;
    updateCyberfoxConfirmNow?: string;
    updateCyberfoxConfirmTitle?: string;
    updatingCyberfox: string;
  ...
  // ── Achievements plugin (plugins/cyberfox-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
