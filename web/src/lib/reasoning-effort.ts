 ...
 *
 * Values mirror cyberfox_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Cyberfox default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Cyberfox' default when unset). */
