 ...
 * `window.__CYBERFOX_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Cyberfox brand in the top bar
 ...
 *  `window.__CYBERFOX_PLUGINS__.registerSlot(...)`.
 *
