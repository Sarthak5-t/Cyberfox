...
const STORAGE_KEY = "cyberfox-dashboard-theme";
...
const FONT_STORAGE_KEY = "cyberfox-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `cyberfox_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "cyberfox-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-cyberfox-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-cyberfox-theme-font", "true");
