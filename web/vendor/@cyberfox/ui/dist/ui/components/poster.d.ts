 ...
 *   marks and a tiny "Cyberfox Agent" mark in the corner.
...
export interface PosterProps {
    ...
    /**
     * Signature mark. In `vibe` this is the small "Cyberfox Agent" overlay in the
     * bottom-right. In `dispatch` this is the URL / CTA in the footer.
     */
    signature?: React.ReactNode;
    /** Override the poster image. Defaults to the "filler-bg0" asset. */
    src?: string;
