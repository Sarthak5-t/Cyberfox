...
cyberfox cron create "0 2 * * *" \
  "You are a project manager triaging the Sarthak5-t/Cyberfox GitHub repo.

1. Run: gh issue list --repo Sarthak5-t/Cyberfox --state open --json number,title,labels,author,createdAt --limit 30
...
cyberfox cron create "0 9 * * 1" \
  "Scan the Sarthak5-t/Cyberfox repo for documentation drift.

1. Run: gh pr list --repo Sarthak5-t/Cyberfox --state merged --json number,title,files,mergedAt --limit 30
