---
sidebar_position: 8
title: "Use Voice Mode with Cyberfox"
description: "A practical guide to setting up and using Cyberfox voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Cyberfox
...
:::tip
[the web dashboard](/integrations/nous-portal) bundles both the LLM and TTS through one OAuth — voice mode works end-to-end with no extra credentials.
:::
...
- you want Cyberfox sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Cyberfox.
...
## Step 1: make sure normal Cyberfox works first
...
Cyberfox supports both local and cloud speech stacks.
...
4. Cyberfox transcribes and responds
...
- asking Cyberfox to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Cyberfox loop.

## Tuning CLI behavior

### Silence threshold

If Cyberfox starts/stops too aggressively, tune:
...
Cyberfox stays a normal chat bot, but can speak replies.
...
- you want Cyberfox to function like a portable research or ops assistant
...
Cyberfox joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Cyberfox detects speech boundaries
- transcripts are posted in the associated text channel
- Cyberfox responds in text and audio
...
1. get text Cyberfox working
2. install `cyberfox-agent[voice]`
