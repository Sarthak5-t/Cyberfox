...
slug: /
sidebar_position: 0
title: "Cyberfox Agent Documentation"
description: "The self-improving AI agent built by Cyberfox. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Cyberfox](https://github.com/Sarthak5-t/Cyberfox). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
>
  ...
  <a
    href="https://github.com/Sarthak5-t/Cyberfox/hermes-agent"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
      border: "1px solid rgba(255,215,0,0.2)",
...
To easily install the command-line and desktop applications, [download the Hermes Desktop installer](https://github.com/Sarthak5-t/Cyberfox/) from our website and run it.
...
After installing, run `hermes setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [the web dashboard](/integrations/nous-portal).
:::

## What is Cyberfox Agent?
...
- **Built by model trainers** — Created by [Cyberfox](https://github.com/Sarthak5-t/Cyberfox), the lab behind Hermes, Nomos, and Psyche. Works with [the web dashboard](https://github.com/Sarthak5-t/Cyberfox), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [the web dashboard](/integrations/nous-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Cyberfox](https://github.com/Sarthak5-t/Cyberfox) — the lab behind Hermes, Nomos, and Psyche models
