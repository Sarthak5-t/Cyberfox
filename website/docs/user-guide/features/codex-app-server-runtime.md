...
:::tip
Not using OpenAI Codex? `cyberfox setup --portal` configures a non-Codex backend with Claude/Gemini/etc. in one step. See [the web dashboard](/integrations/nous-portal).
:::
...
If you find a bug, [open an issue](https://github.com/Sarthak5-t/Cyberfox/issues) with the output of `cyberfox logs --since 5m`. Mention `codex-runtime` in the title so it's easy to triage.
...
For implementation details, see [PR #24182](https://github.com/Sarthak5-t/Cyberfox/pull/24182) and the [Codex app-server protocol README](https://github.com/openai/codex/blob/main/codex-rs/app-server/README.md).
