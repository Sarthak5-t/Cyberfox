...
chat completions — use your Cyberfox-managed provider subscription as their
...
| Use case | "Use Cyberfox as a chat backend" | "Use my Portal sub from another app" |
...
Model:      Cyberfox-4-70B    # or Cyberfox-4.3-36B, Cyberfox-4-405B
```
...
`cyberfox_cli/proxy/adapters/<provider>.py` and registering it in
