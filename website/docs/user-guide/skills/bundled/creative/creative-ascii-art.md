...
```bash
python3 -m pyfiglet "CYBERFOX" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=CYBERFOX&font=Slant" | boxes -d stone
```
