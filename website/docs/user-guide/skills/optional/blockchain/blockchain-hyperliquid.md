...
| | |
|---|---|
| Source | Optional — install with `cyberfox skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Cyberfox Agent |
| License | MIT |
...
The script reads `${CYBERFOX_HOME:-~/.cyberfox}/.env` for two optional defaults:
...
Helper script: `~/.cyberfox/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.cyberfox/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${CYBERFOX_HOME:-~/.cyberfox}/.env`.
...
```bash
python3 ~/.cyberfox/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.cyberfox/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
