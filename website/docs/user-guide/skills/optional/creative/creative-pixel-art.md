...
| | |
|---|---|
| Source | Optional — install with `cyberfox skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.cyberfox/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.cyberfox/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Cyberfox installs package this)
