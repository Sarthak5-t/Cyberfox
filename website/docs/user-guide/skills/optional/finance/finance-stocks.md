...
| | |
|---|---|
| Source | Optional — install with `cyberfox skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Cyberfox Agent |
| License | MIT |
...
```
SCRIPT=~/.cyberfox/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.cyberfox/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
