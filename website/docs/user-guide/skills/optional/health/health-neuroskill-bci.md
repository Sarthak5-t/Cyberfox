...
| | |
|---|---|
| Source | Optional — install with `cyberfox skills install official/health/neuroskill-bci` |
...
Connect Cyberfox to a running [NeuroSkill](https://neuroskill.com/) instance to read
