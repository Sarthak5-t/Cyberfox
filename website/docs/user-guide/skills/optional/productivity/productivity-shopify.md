...
| | |
|---|---|
| Source | Optional — install with `cyberfox skills install official/productivity/shopify` |
...
4. Save to `${CYBERFOX_HOME:-~/.cyberfox}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Cyberfox","productType":"Apparel","tags":["test"]}}'
```
