...
| | |
|---|---|
| Source | Optional — install with `cyberfox skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Cyberfox Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $CYBERFOX_OSINT_CACHE/icij/ (default: ~/.cache/cyberfox-osint/icij/).
...
# Set CYBERFOX_OSINT_UA=your-app/1.0 (your@email) to identify yourself
