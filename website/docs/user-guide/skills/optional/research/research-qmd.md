...
| | |
|---|---|
| Source | Optional — install with `cyberfox skills install official/research/qmd` |
...
Cyberfox Agent via the native MCP client. This is the preferred
...
Then configure Cyberfox Agent to connect via HTTP:
