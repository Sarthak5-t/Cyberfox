...
| | |
|---|---|
| Source | Optional — install with `cyberfox skills install official/software-development/subagent-driven-development` |
| Path | `optional-skills/software-development/subagent-driven-development` |
| Version | `1.1.0` |
| Author | Cyberfox Agent (adapted from obra/superpowers) |
| License | MIT |
