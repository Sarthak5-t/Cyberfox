...
- User wants **Cyberfox itself to drive a browser** → use Cyberfox' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
