#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Cyberfox docs site.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Cyberfox as a Python Library", None),
        ("guides/use-mcp-with-cyberfox", "Use MCP with Cyberfox", None),
        ("guides/use-voice-mode-with-cyberfox", "Use Voice Mode with Cyberfox", None),
        ("guides/use-soul-with-cyberfox", "Use SOUL.md with Cyberfox", None),
        ("guides/build-a-cyberfox-plugin", "Build a Cyberfox Plugin", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Cyberfox"),
...
def emit_llms_index() -> str:
    ...
    lines: list[str] = []
    lines.append("# Cyberfox Agent")
    lines.append("")
    lines.append(
        "> The self-improving AI agent created by Sarthak Khatal. A terminal-native "
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Cyberfox Agent — Full Documentation\n",
        (
            "This file is the entire Cyberfox Agent documentation concatenated for LLM "
